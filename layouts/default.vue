<template>
  <div :class="{ 'dark-mode': isDarkMode }" style="font-family: Verdana, Geneva, Tahoma, sans-serif">
   ...
   <div v-if="loading" class="preloader text-white">
     ...
     <header>
       <nav
        :style="{ backgroundColor: isDarkMode ? 'rgba(9, 21, 32, 0.9)' : '#ffffff' }"
       ...
       >
         <div class="container">
           ...
           <img
            ...
            style="width: 45px;font-size: 15px" 
            src="../public/bull.webp" />
             <!-- <span  style="font-size: 16px"  class=" fw-bold" 
               > Crypto Bulls</span
             > -->
              <img class="pointer" style="width: 180px;margin-left: 5px;margin-top: 16px;" src="../public/2.png">
           </NuxtLink>
           ...
           >
           <i :class="{ 'dark-mode': isDarkMode }" class="bi bi-list"></i>
             <!-- <svg
           ...
           <div class="collapse navbar-collapse" id="navbarNav">
             ...
             <ul class="navbar-nav ms-auto text align-items-center">
               ...
               <li class="nav-item dropdown" ref="dropdownMenu" @click="toggleDropdown">
               <span style="margin-right: 10px;" class="fw-bold pointer">Crypto Bulls Lab</span>
                 
               <!-- <img class="pointer" style="width: 220px;" src="../public/2.png"> -->
                 ...
                 <NuxtLink to="/" class="dropdown-item " aria-current="page"
                   ><i class="bi bi-house-add"></i> Home</NuxtLink
                 >
               </li>
                   <li>
                     <NuxtLink to="/ai" class="dropdown-item"
                       ><i class="bi bi-robot"></i> Artificial intelligence</NuxtLink
                     >
                   </li>
                   <li class="nav-item">
                     <NuxtLink to="/altcoins" class="dropdown-item"
                       ><i class="bi bi-coin"></i> Altcoins</NuxtLink
                     >
                   </li>
                   <li class="nav-item">
                     <NuxtLink
                       ...
                       class="dropdown-item"
                       aria-current="page"
                       ><i class="bi bi-journal-album"></i> Articles</NuxtLink
                     >
                   </li>
                   <li class="nav-item">
                     <NuxtLink to="/crypto" class="dropdown-item"
                       ><i class="bi bi-currency-bitcoin"></i> Bitcoin & Ethereum</NuxtLink
                     >
                   </li>
 
                   <li class="nav-item">
                     <NuxtLink to="/contact" class="dropdown-item"
                       ><i class="bi bi-people-fill"></i> Blockchain people</NuxtLink
                     >
                   </li>
                   <li>
                   ...
                   <li class="nav-item">
                     <NuxtLink to="/defi" class="dropdown-item"><i class="bi bi-safe"></i> Defi</NuxtLink>
                   </li>
                   <!-- <li>
                   ...
                   <li>
                     <NuxtLink to="/exchanges" class="dropdown-item"
           ...
           <li class="sidebar-item">
             ...
             <button class="btn" @click="toggleSearch">
               <img style="width: 23px;height: 23px;" src="https://static.vecteezy.com/system/resources/thumbnails/037/047/109/small_2x/ai-generated-stylized-globe-icon-symbol-3d-isolated-on-transparent-background-png.png"/>
             ...
             >
               <input
               style="width: 150px; background-color: transparent !important;color:cornflowerblue;"
                 v-model="searchQuery"
                 type="text"
     ...
     -->
       ...
       <aside
         style=""
         :class="['sidebar', { open: isSidebarOpen, 'dark-sidebar': isDarkMode, 'light-sidebar': !isDarkMode }]"
       >
         ...
         <NuxtLink to="/" class="navbar-brand" style="">
           <img style="width: 50px;margin-left: 20px;" src="../public/bull.webp" />
         ...
         <ul style="" class="sidebar-nav">
           ...
           <li class="sidebar-item">
             <NuxtLink to="/articles" class="sidebar-link" @click="toggleSidebar"
               >Articles</NuxtLink
             >
           </li>
           <!-- <li class="sidebar-item">
           ...
           <li>
                     <NuxtLink to="/chartsCrypto" class="sidebar-link" @click="toggleSidebar"
                       >Charts
                     </NuxtLink>
                   </li>
           <li class="sidebar-item">
           ...
           <li class="sidebar-item">
             <NuxtLink to="/exchanges" class="sidebar-link" @click="toggleSidebar"
               >Exchanges</NuxtLink
             >
           </li>
           <li class="sidebar-item">
           ...
           >
             ...
             >
               ...
               <div class="card-body">
                 ...
                 <a style="color:cornflowerblue" :href="result.url" target="_blank" class="">
...
export default {
 ...
 .theme-toggle-btn {
   ...
   position: absolute;
   right: 0px; /* Подгоните это значение под ваше меню */
 }
 ...
 /* Прозрачный фон для светлой темы */
 .light-sidebar {
 ...
 /* Фон для тёмной темы */
 .dark-sidebar {
   background-color:  rgba(9, 21, 32, 1);
   color: white;
 }

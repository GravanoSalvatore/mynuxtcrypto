<template>
  <div class="privacy-policy container my-4">
    ...
    <p>
      Если у вас есть вопросы или комментарии по поводу настоящей Политики конфиденциальности, пожалуйста, свяжитесь с нами по адресу: <a href="mailto:cryptocurrencybulls.com">cryptocurrencybulls.com</a>.
    </p>
  </div>
</template>

      ...
      <div class="row" v-if="articles && articles.length">
        ...
        >
          <div class="article-card text-center" @click="selectArticle(index)">
            ...
            />
            <div class="card-body">
            <h5 class="card-title">{{ article.firstName }} {{ article.lastName }}</h5>
          </div>
          </div>
        </div>
      </div>
    ...
    <div v-if="selectedArticle" class="selected-article">
      <div class="row">
        ...
        <div class="col-md-3 news-sidebar" style="background-color:">
          <div
  v-for="(newsItem, index) in latestNews.slice(25)"
  :key="index"
    ...
    {{ formatDate(newsItem.published_on) }}
        ...
        <div class="col-md-9 article-content">
          ...
          <div class="article-container">
            ...
            <img :src="selectedArticle.image" class="img-fluid personality-image rounded-4" alt="person image" />
            <div class="personality-text">
              <h2 class="fw-bold">{{ selectedArticle.firstName }} {{ selectedArticle.lastName }}</h2>
              <p>{{ selectedArticle.bio }}</p>
            </div>
          </div>
...
<script>
import { useNews3 } from "~/composables/people";
